...
from network import SEQPeptide
...
parser.add_argument('--model', type=str, default='mlp',
                    help='mlp gru lstm rnn tf mamba')
...
parser.add_argument('--mlp', type=str, default='./run/mlp-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--gru', type=str, default='./run/gru-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--lstm', type=str, default='./run/lstm-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--rnn', type=str, default='./run/rnn-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--tf', type=str, default='./run/tf-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--mamba', type=str, default='./run/mamba-bce256-0.001-50',
                    help='path of the pretrain model')
...
model_path = {'mlp': args.mlp, 'gru': args.gru, 'lstm': args.lstm, 'rnn': args.rnn, 'tf': args.tf, 'mamba': args.mamba}
...
def main():
    ...
    models = {'mlp': SEQPeptide(classes=args.classes, q_encoder='mlp'),
              'gru': SEQPeptide(classes=args.classes, q_encoder='gru'),
              'lstm': SEQPeptide(classes=args.classes, q_encoder='lstm'),
              'rnn': SEQPeptide(classes=args.classes, q_encoder='rnn'),
              'tf': SEQPeptide(classes=args.classes, q_encoder='tf'),
              'mamba': SEQPeptide(classes=args.classes, q_encoder='mamba')}
