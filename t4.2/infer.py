...
from network import GLOBPeptide
...
parser.add_argument('--pdb-src', type=str, dest='pdb_src', default='no',
                    help='no, af or hf')
...
parser.add_argument('--alphafold', type=str, default='./run/af-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--helixfold', type=str, default='./run/hf-bce256-0.001-50',
                    help='path of the pretrain model')
parser.add_argument('--seq', type=str, default='./run/no-bce256-0.001-50',
                    help='path of the pretrain model')
...
model_path = {'alphafold': args.alphafold, 'helixfold': args.helixfold, 'seq': args.seq}
...
def main():
    ...
    model = GLOBPeptide(classes=qlx_set.num_classes, q_encoder=args.model)
