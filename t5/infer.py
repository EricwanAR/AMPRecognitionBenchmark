...
parser.add_argument('--sd', type=str, default='./run/101-bce256-0.001-50af',
                    help='path of the pretrain model')
parser.add_argument('--sv', type=str, default='./run/110-bce256-0.001-50af',
                    help='path of the pretrain model')
parser.add_argument('--vd', type=str, default='./run/011-bce256-0.001-50af',
                    help='path of the pretrain model')
parser.add_argument('--svd', type=str, default='./run/111-bce256-0.001-50af',
                    help='path of the pretrain model')
...
model_path = {'Seq.+Disc.': args.sd, 'Seq.+Voxel': args.sv, 'Voxel+Disc.': args.vd, 'Seq.+Voxel+Disc.': args.svd}
...
def main():
    ...
    models = {'Seq.+Disc.': FusionPeptide(classes=qlx_set.num_classes, v_encoder=args.model, channels=args.channels, mode='101'),
              'Seq.+Voxel': FusionPeptide(classes=qlx_set.num_classes, v_encoder=args.model, channels=args.channels, mode='110'),
              'Voxel+Disc.': FusionPeptide(classes=qlx_set.num_classes, v_encoder=args.model, channels=args.channels, mode='011'),
              'Seq.+Voxel+Disc.': FusionPeptide(classes=qlx_set.num_classes, v_encoder=args.model, channels=args.channels, mode='111')}
